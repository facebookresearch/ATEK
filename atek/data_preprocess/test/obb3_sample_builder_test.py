...
from atek.data_preprocess.sample_builders.cubercnn_sample_builder import (
    CubeRCNNSampleBuilder,
)
...
class Obb3SampleBuilderTest(unittest.TestCase):
    ...
    def test_get_obb3_sample(self) -> None:
        conf = OmegaConf.load(os.path.join(CONFIG_DIR, "obb3_preprocess_base.yaml"))
...
class CubeRCNNSampleBuilderTest(unittest.TestCase):
    def setUp(self) -> None:
        super().setUp()

    def test_get_obb3_sample(self) -> None:
        conf = OmegaConf.load(os.path.join(CONFIG_DIR, "cubercnn_preprocess_base.yaml"))
